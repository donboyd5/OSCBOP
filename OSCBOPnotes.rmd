...
#   fbdbd <- "E:\\Data\\Federal budget and spending\\FFY 2015\\Database\\"
  ...
  usasd <- paste0(bopd, "USASpending\\")
  # E:\Dropbox (Personal)\sharedData\Data for projects\OSC BOP project\USASpending
#   grantsd <- paste0(usasd, "Grants\\")
#   dpayd <- paste0(usasd, "DirectPayments\\")
#   contrd <- paste0(sdatd, "OSCBOP")
...
```{r contracts, child=paste0("subContracts.Rmd"), eval=TRUE}
# don't put anything else here - it WILL NOT BE RUN!
```
